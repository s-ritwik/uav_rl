...
@configclass
class LandingSwayVelocityActionCfg(ActionTermCfg):
...
class LandingSwayVelocityAction(ActionTerm):
    """
    ...
    cfg: LandingSwayVelocityActionCfg
    _asset: Articulation

    def __init__(self, cfg: LandingSwayVelocityActionCfg, env):
...
LandingSwayVelocityActionCfg.class_type = LandingSwayVelocityAction
PX4LikeVelocityActionCfg = LandingSwayVelocityActionCfg
PX4LikeVelocityAction = LandingSwayVelocityAction
