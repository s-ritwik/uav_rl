...
@configclass
class LandingRpsVelocityActionCfg(ActionTermCfg):
...
class LandingRpsVelocityAction(ActionTerm):
    """
    ...
    cfg: LandingRpsVelocityActionCfg
    _asset: Articulation

    def __init__(self, cfg: LandingRpsVelocityActionCfg, env):
...
LandingRpsVelocityActionCfg.class_type = LandingRpsVelocityAction
PX4LikeVelocityActionCfg = LandingRpsVelocityActionCfg
PX4LikeVelocityAction = LandingRpsVelocityAction
