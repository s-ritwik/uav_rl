...
@configclass
class LandingRpsDomainRandomizationCfg:
    """Domain-randomization switches and sampling ranges for the landing_rps UAV task."""
...
class LandingRpsDomainRandomizationState:
    """Per-environment runtime state sampled from :class:`LandingRpsDomainRandomizationCfg`."""

    def __init__(self, cfg: LandingRpsDomainRandomizationCfg, num_envs: int, device: torch.device | str):
        self.cfg = cfg
...
def get_domain_randomization_state(env) -> LandingRpsDomainRandomizationState | None:
    state = getattr(env, "_landing_rps_domain_randomization", None)
    if state is not None:
        return state
    # Backward compatibility for runs created before the landing_rps attribute rename.
...
VanillaDomainRandomizationCfg = LandingRpsDomainRandomizationCfg
VanillaDomainRandomizationState = LandingRpsDomainRandomizationState
