...
@configclass
class LandingSwayDomainRandomizationCfg:
    """Domain-randomization switches and sampling ranges for the landing_sway UAV task."""
...
class LandingSwayDomainRandomizationState:
    """Per-environment runtime state sampled from :class:`LandingSwayDomainRandomizationCfg`."""

    def __init__(self, cfg: LandingSwayDomainRandomizationCfg, num_envs: int, device: torch.device | str):
        self.cfg = cfg
...
def get_domain_randomization_state(env) -> LandingSwayDomainRandomizationState | None:
    state = getattr(env, "_landing_sway_domain_randomization", None)
    if state is not None:
        return state
    # Backward compatibility for runs created before the landing_sway attribute rename.
...
VanillaDomainRandomizationCfg = LandingSwayDomainRandomizationCfg
VanillaDomainRandomizationState = LandingSwayDomainRandomizationState
