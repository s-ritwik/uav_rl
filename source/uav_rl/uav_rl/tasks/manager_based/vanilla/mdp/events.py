...
from .randomization import VanillaDomainRandomizationCfg, VanillaDomainRandomizationState
...
class SampleVanillaDomainRandomization(ManagerTermBase):
    ...
    def __call__(
        ...
        rand_cfg: VanillaDomainRandomizationCfg | None = None,
