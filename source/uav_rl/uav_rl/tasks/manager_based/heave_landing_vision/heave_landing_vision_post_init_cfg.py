...
if TYPE_CHECKING:
    from .heave_landing_vision_env_cfg import HeaveLandingVisionEnvCfg


@configclass
class HeaveLandingRewardWeightsCfg:
    """Reward weights applied in ``HeaveLandingVisionEnvCfg.__post_init__``."""
...
@configclass
class HeaveLandingVisionObservationCfg:
    """Real onboard-camera vision settings used inside the RL environment."""

    camera_prim_path: str = "body/body/Camera"
...
@configclass
class HeaveLandingVisionPostInitCfg:
    ...
    vision_observation: HeaveLandingVisionObservationCfg = HeaveLandingVisionObservationCfg()
    ...
    def apply(self, env_cfg: HeaveLandingVisionEnvCfg) -> None:
        ...
        env_cfg.scene.onboard_camera.prim_path = f"{{ENV_REGEX_NS}}/Robot/{self.vision_observation.camera_prim_path}"
        env_cfg.scene.onboard_camera.width = int(self.vision_observation.camera_width_px)
        env_cfg.scene.onboard_camera.height = int(self.vision_observation.camera_height_px)
