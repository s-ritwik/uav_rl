...
@configclass
class HeaveLandingVisionCustomGruActorCriticCfg(RslRlPpoActorCriticRecurrentCfg):
...
@configclass
class HeaveLandingVisionFfPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 2000
    save_interval = 100
    experiment_name = "heave_landing_vision_ff"
...
class HeaveLandingVisionGruPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    policy = HeaveLandingVisionCustomGruActorCriticCfg(
        init_noise_std=1.0,
        noise_std_type="log",
        actor_obs_normalization=False,
        critic_obs_normalization=False,
...
PPORunnerCfg = HeaveLandingVisionFfPPORunnerCfg
