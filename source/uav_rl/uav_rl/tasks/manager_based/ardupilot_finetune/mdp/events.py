...
from ...vanilla.mdp.events import *  # noqa: F401, F403
from ...vanilla.mdp.events import MultiSinePlatformMotion as VanillaMultiSinePlatformMotion
...
class MultiSinePlatformMotionAfterReady(VanillaMultiSinePlatformMotion):
    """Freeze the platform until ArduPilot SITL reaches the pre-policy hover state."""
